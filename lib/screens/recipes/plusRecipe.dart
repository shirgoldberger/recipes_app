...
class _PlusRecipeState extends State<PlusRecipe> {
                ...
                child: Form(
                    ...
                    child: Column(children: <Widget>[
                      Flexible(
                        ...
                        Text(
                          'Enter details about your recipe:',
                          style: TextStyle(
                              fontFamily: 'Raleway',
                              fontSize: 20,
  ...
  void saveThisRecipe() async {
    ...
    Recipe recipe = Recipe(recipeName, recipeDescription, myTags, level, notes,
        writerName, writerUid, time, true, '', '', imagePath);
