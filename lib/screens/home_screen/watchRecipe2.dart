...
import 'package:recipes_app/screens/home_screen/watchMyRecipe.dart';
import 'package:recipes_app/screens/home_screen/watchPublishRecipe.dart';
import 'package:recipes_app/screens/home_screen/watchSaveRecipe.dart';
...
class WatchRecipe2 extends StatefulWidget {
  WatchRecipe2(Recipe r, bool home) {
    this.current = r;
    this.home = home;
  }
...
class _WatchRecipeState extends State<WatchRecipe2> {
  var i;
  @override
  void initState() {
    super.initState();
